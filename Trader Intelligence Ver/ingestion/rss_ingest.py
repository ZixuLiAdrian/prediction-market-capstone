...
class RSSIngestor(BaseIngestor):
    """Ingestor that pulls headlines and summaries from configured RSS feeds."""

    source_type = "rss"

    def fetch(self) -> List[Event]:
        """Fetch events from all configured RSS feed URLs and return them as a list of Events."""
        events = []
