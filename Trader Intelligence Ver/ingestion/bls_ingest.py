...
class BLSIngestor(BaseIngestor):
    """Ingestor that fetches the latest economic indicator readings from the BLS public API."""

    source_type = "official"

    def fetch(self) -> List[Event]:
        """Fetch the most recent value for each configured BLS series and return them as Events."""
        events = []
