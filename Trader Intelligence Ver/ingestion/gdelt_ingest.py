...
class GDELTIngestor(BaseIngestor):
    """Ingestor that queries the GDELT DOC 2.0 API for recent news articles matching configured terms."""

    source_type = "gdelt"

    def fetch(self) -> List[Event]:
        """Fetch articles from GDELT matching the configured query and return them as Events."""
        events = []
