...
class SECIngestor(BaseIngestor):
    """Ingestor that fetches recent SEC filings (8-K, Form 4, etc.) from the EDGAR RSS feed."""

    source_type = "official"

    def fetch(self) -> List[Event]:
        """Fetch recent filings for each configured form type via the EDGAR Atom feed."""
        events = []
