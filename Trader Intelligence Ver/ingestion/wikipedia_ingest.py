...
class WikipediaIngestor(BaseIngestor):
    """Ingestor that detects attention spikes via Wikimedia Pageviews API for yesterday's top pages."""

    source_type = "social"

    def fetch(self) -> List[Event]:
        """Fetch yesterday's top Wikipedia pages above the configured pageview threshold."""
        events = []
