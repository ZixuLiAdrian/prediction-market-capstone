...
class MarketIngestor(BaseIngestor):
    """Ingestor that fetches active market listings from Polymarket as benchmark signals."""

    source_type = "market"

    def fetch(self) -> List[Event]:
        """Fetch active Polymarket markets ordered by volume and return them as Events."""
        events = []
