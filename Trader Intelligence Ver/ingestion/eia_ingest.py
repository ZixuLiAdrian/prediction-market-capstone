...
class EIAIngestor(BaseIngestor):
    """Ingestor that fetches the latest energy market data for configured series from the EIA API."""

    source_type = "official"

    def fetch(self) -> List[Event]:
        """Fetch the most recent data point for each configured EIA series and return them as Events."""
        events = []
