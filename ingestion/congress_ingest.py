...
class CongressIngestor(BaseIngestor):
    """Ingestor that fetches recently updated bills and legislation from the Congress.gov API."""

    source_type = "official"

    def fetch(self) -> List[Event]:
        """Fetch the most recently updated bills from Congress.gov and return them as Events."""
        events = []
