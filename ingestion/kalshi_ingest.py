...
class KalshiIngestor(BaseIngestor):
    """Ingestor that fetches open market listings from the Kalshi trade API as benchmark signals."""

    source_type = "market"

    def fetch(self) -> List[Event]:
        """Fetch open Kalshi markets and return them as Events with signal_role='benchmark'."""
        events = []
